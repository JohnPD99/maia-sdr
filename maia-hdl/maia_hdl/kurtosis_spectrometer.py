...
class Kurthosis_Spectrometer(Elaboratable):
    ...
    This elaboratable uses an FFT and a s1_s2_module to compute
    RFI filtered waterfall data. The data is written to an AXI bus using a DMA
    (DMABramWrite).
...
if __name__ == '__main__':
    spectrometer = Kurthosis_Spectrometer(0x1000_0000, 5)
    amaranth.cli.main(
