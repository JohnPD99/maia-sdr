...
class S1_S2_module(Elaboratable):
    """S1_S2_module

    This module uses a CpwrTR, a CPWR2TR and a BRAM to compute the integrated power and the integrated square of the power.
    This is then used to perform spectral Kurtosis on the integration. 
    The number of integrations must be equal to 2^x and can be changed at runtime.
